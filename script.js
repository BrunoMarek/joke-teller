...
// Passing Joje to VoiceRSS API
function tellMe(jokes) {
    console.log('tell me: ', jokes);
        VoiceRSS.speech({
            // quando subir no github tirar a api key
        key: '254a9802a4ca4d4a93c5d04d33e4d555',
        src: jokes,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let jokes = '';
    const urlAPI = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,political,racist,sexist,explicit';
    try{
